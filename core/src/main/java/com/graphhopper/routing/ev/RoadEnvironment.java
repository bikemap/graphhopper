...
public enum RoadEnvironment {
    ...
    CYCLE_LEFT("cycle_left"), CYCLE_LEFT_NO("cycle_left_no"), CYCLE_RIGHT_ONEWAY("cycle_right_oneway"),
    BICYCLE_ONEWAY_YES("bicycle_oneway_yes"), BICYCLE_ONEWAY_NO("bicycle_oneway_no"),
    CYCLE_LEFT_ONEWAY("cycle_left_oneway"), CYCLE_BOTH("cycle_both"), CYCLE_BOTH_NO("cycle_both_no"), CYCLE_WIDTH("cycle_width"),
    CYCLE_RIGHT_BICYCLE("cycle_right_bicycle"), CYCLE_BOTH_LANE("cycle_both_lane"),
    CYCLE_RIGHT_SEGREGATED("cycle_right_segregated"), CYCLE_RIGHT("cycle_right"), CYCLE_RIGHT_NO("cycle_right_no"),
