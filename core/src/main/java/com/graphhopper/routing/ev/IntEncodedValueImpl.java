...
import com.graphhopper.util.StaticJavaSourceVersion;
...
public class IntEncodedValueImpl implements IntEncodedValue {
    ...
    static boolean isValidEncodedValue(String name) {
        ...
        } catch (Throwable t) { // covers NoClassDefFoundError, NoSuchMethodError, LinkageError, etc.
            isKeyword = StaticJavaSourceVersion.isKeyword(name);
        }
